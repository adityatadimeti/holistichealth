        ...
        {!user.userID ? (
          <>
            <p className="text-[24px] font-semibold">
              Connect a user to the the REST API
            </p>
          </>
        ) : (
          <>
            <p className="text-[24px] font-semibold w-full">
              REST API - Fetch historical user data
            </p>
            <div className="w-full flex flex-col gap-4">
              ...
              />
              <button
                className="bg-white px-4 py-2 rounded-full border-2 border-black text-[#008AFF] hover:bg-opacity-70"
                onClick={async () => {
              ...
              <input
                ...
                style={{ height: "24px", fontSize: "15px", padding: "15px" }}
                onChange={(e) => {
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  console.log(performMyAction({ foodName: enteredFood }));
                }}
              >
                Get food
              </button>
